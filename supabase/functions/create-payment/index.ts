...
serve(async (req) => {
  ...
  try {
    ...
    const FALLBACK_PRICE_DATA: Record<string, { amount: number; name: string }> = {
      ...
      buy_moves: { amount: 20, name: "Buy Moves" },
      extra_moves: { amount: 20, name: "Extra Moves" },
      quick_pack: { amount: 99, name: "Quick Pack" },
      quick_life: { amount: 20, name: "Quick Life" },
      starter_pack: { amount: 99, name: "Starter Pack" },
      continue_game: { amount: 20, name: "Continue Game" },
      welcome_pack: { amount: 20, name: "Welcome Pack" },
      flash_offer: { amount: 99, name: "Flash Offer" },
      victory_multiplier: { amount: 20, name: "Victory Multiplier" },
      finish_level: { amount: 20, name: "Finish Level" },
      no_ads_month: { amount: 499, name: "No Ads Month" },
      no_ads_forever: { amount: 999, name: "No Ads Forever" },
      garden_pass: { amount: 999, name: "Garden Pass" },
      lifesaver_pack: { amount: 20, name: "Lifesaver Pack" },
      streak_protection: { amount: 20, name: "Streak Protection" },
      extra_spin: { amount: 20, name: "Extra Spin" },
      reward_doubler: { amount: 20, name: "Reward Doubler" },
      unlimited_lives_30min: { amount: 99, name: "Unlimited Lives 30min" },
      chest_silver: { amount: 99, name: "Chest Silver" },
      ...
      pack_victoria_segura: { amount: 399, name: "Pack Victoria Segura" },
      pack_racha_infinita: { amount: 199, name: "Pack Racha Infinita" },
      pack_impulso: { amount: 99, name: "Pack Impulso" },
      pack_experiencia: { amount: 399, name: "Pack Experiencia" },
      pack_victoria_segura_pro: { amount: 399, name: "Pack Victoria Segura Pro" },
      first_purchase: { amount: 20, name: "First Purchase Pack" },
    };
