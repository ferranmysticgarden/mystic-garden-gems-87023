...
export const Board = ({ onMatch, onMove, targetTile, disabled, levelId }: BoardProps) => {
  ...
  // Pre-designed boards for early levels — NO existing matches, but obvious swaps
  // RULE: No 3-in-a-row horizontally or vertically, but one swap creates a match
  const getEasyBoard = useCallback((lvl: number): string[][] | null => {
    if (lvl === 1) {
      // Score objective: many easy swaps available, no pre-existing matches
      // Swap (1,1)↔(1,2) creates 🌸🌸🌸 in row 1
      // Swap (3,2)↔(3,3) creates 🌺🌺🌺 in row 3
      // Swap (5,1)↔(5,2) creates 🌼🌼🌼 in row 5
      return [
        ['🌸','🌺','🌼','🍃','🌻','🌷','🌸','🌺'],
        ['🌼','🌸','🌺','🌸','🌻','🌼','🍃','🌻'],
        ['🌺','🌻','🌸','🌷','🍃','🌸','🌺','🌼'],
    ...
    if (lvl === 2) {
      // Collect 🌸 objective: lots of 🌸 pairs near each other for easy swaps
      // Swap (0,1)↔(1,1) creates 🌸🌸🌸 in col 1
      // Swap (2,4)↔(3,4) creates 🌸🌸🌸 in col 4
      // Many 🌸 on board for high collection count
      return [
        ['🌺','🌸','🌼','🌻','🌸','🌺','🌼','🌻'],
        ['🌼','🌻','🌸','🌺','🌼','🌸','🌻','🌺'],
        ['🌸','🌺','🌻','🌸','🌻','🌼','🌸','🌷'],
    ...
    if (lvl === 3) {
      // Collect 🍃 objective: lots of 🍃 pairs for easy swaps
      return [
        ['🌺','🍃','🌸','🌼','🍃','🌻','🌸','🌺'],
        ['🍃','🌻','🍃','🌺','🌸','🍃','🌼','🌷'],
        ['🌸','🍃','🌻','🍃','🌼','🌸','🍃','🌻'],
