...
const GOOGLE_PLAY_ID_OVERRIDES: Record<string, string[]> = {
  ...
  theme_racing_unlock: ['theme_racing_unlock_b6gi8nmipn', 'themeracingunlockb6gi8nmipn'],
  theme_pirates_unlock: ['theme_pirates_unlock_b6gi8nmipn', 'themepiratesunlockb6gi8nmipn'],
  theme_unicorns_unlock: ['theme_unicorns_unlock_b6gi8nmipn', 'themeunicornsunlockb6gi8nmipn'],
  theme_manga_unlock: ['theme_manga_unlock_b6gi8nmipn', 'thememangaunlockb6gi8nmipn'],
