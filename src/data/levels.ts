...
export const LEVELS: Level[] = [
  ...
  { id: 10, objective: { type: 'score', target: 'points', count: 1100 }, moves: 22, stars: { one: 1100, two: 1400, three: 1700 }, reward: { gems: 100 } },
  // BONUS tras nivel 10
  ...
  // L22 pico, L23 relief
  { id: 22, objective: { type: 'score', target: 'points', count: 1670 }, moves: 25, stars: { one: 1670, two: 2070, three: 2470 }, reward: {} },
  ...
  { id: 28, objective: { type: 'score', target: 'points', count: 1125 }, moves: 25, stars: { one: 1125, two: 1525, three: 1925 }, reward: {} },
  ...
  // L37 pico, L38 relief
  { id: 37, objective: { type: 'score', target: 'points', count: 1725 }, moves: 25, stars: { one: 1725, two: 2125, three: 2525 }, reward: {} },
  ...
  { id: 43, objective: { type: 'score', target: 'points', count: 1125 }, moves: 25, stars: { one: 1125, two: 1525, three: 1925 }, reward: {} },
